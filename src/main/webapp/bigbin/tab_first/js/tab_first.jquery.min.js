			...
			return this.each(function() {
				...
				if (slides.length > 0) {
					if (!option.customIndicators) {
						for (var i = 0; i < slidecount; i++) {
							if (!option.indicatorLinks) {
								...
								option.indicators.append('<li><a href="#' + i
										+ '"></a></li>');
							}
						}
					}
					...
					the_indicators.click(function() {
						...
						hreftag = hreftag.substring(hreftag.search('#') + 1,
								hreftag.length);
					...
					var jumptostart = function() {
						...
						currentindicator = option.indicators.find('li:eq('
								+ (currentslide) + ')');
