...
(function($) {
	...
	$.alerts = {
		...
		_show : function(title, msg, value, type, callback) {
			...
			// IE6 Fixvar
			pos = ('undefined' == typeof (document.body.style.maxHeight)) ? 'absolute'
					: 'fixed';
			...
			case 'alert':
				$("#popup_message").after(
						'<div id="popup_panel"><span id="popup_ok" class="btn-small" >'
			...
			case 'confirm':
				$("#popup_message")
						.after(
								'<div id="popup_panel"><span id="popup_ok" class="btn-small" >'
										+ $.alerts.okButton
										+ '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="popup_cancel" class="btn-small" >'
										+ $.alerts.cancelButton
										+ '</span> </div>');
				$("#popup_ok").click(function() {
					$.alerts._hide();
